...
public class Core extends ApplicationAdapter {
    Stage stage;
    Group background, middle, foreground, playerGroup;
    TiledMap tiledMap;
    ...
    public void create() {
        ...
        layers[2] = new ParallaxLayer( new Texture( Gdx.files.internal( "bglayers/glacial_mountains.png" ) ), .3f, true, false );
        layers[3] = new ParallaxLayer( new Texture( Gdx.files.internal( "bglayers/clouds_mg_2.png" ) ), .4f, true, false );
    ...
    public void render() {
        ...
        if( dino != null )
            dinoPosition.set( dino.getX() + ( dino.sub.x < 0 ? -100f : 100f ), dino.getY() + 50f);
